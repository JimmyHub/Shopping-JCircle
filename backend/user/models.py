...
class UserProfile(models.Model):
    name=models.CharField(verbose_name='用戶名',max_length=11,primary_key=True)
    password = models.CharField(verbose_name='密碼',max_length=32)
    birthday = models.CharField(verbose_name='生日', max_length=10,null=True)
    phone = models.CharField(verbose_name='電話', max_length=32)
    gender = models.CharField(verbose_name='性別', max_length=10,null=True)
